...
class CandidatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidato" do
    assert_difference('Candidato.count') do
      post candidatos_url, params: { candidato: { email: @candidato.email, escolaridade: @candidato.escolaridade, exp_profissional: @candidato.exp_profissional, nome: @candidato.nome, telefone: @candidato.telefone } }
    end
  ...
  test "should update candidato" do
    patch candidato_url(@candidato), params: { candidato: { email: @candidato.email, escolaridade: @candidato.escolaridade, exp_profissional: @candidato.exp_profissional, nome: @candidato.nome, telefone: @candidato.telefone } }
