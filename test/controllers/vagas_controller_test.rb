...
class VagasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vaga" do
    assert_difference('Vaga.count') do
      post vagas_url, params: { vaga: { local: @vaga.local, modelo: @vaga.modelo, salario: @vaga.salario, titulo: @vaga.titulo } }
    end
  ...
  test "should update vaga" do
    patch vaga_url(@vaga), params: { vaga: { local: @vaga.local, modelo: @vaga.modelo, salario: @vaga.salario, titulo: @vaga.titulo } }
