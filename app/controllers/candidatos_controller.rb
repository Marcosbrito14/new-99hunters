class CandidatosController < ApplicationController
  ...
  def index
    @candidatos = @vaga.candidatos #candidatos da vaga informada pela url
  end
  ...
  def create
    @candidato = @vaga.candidatos.new(candidato_params)

    respond_to do |format|
      if @candidato.save
        format.html { redirect_to candidato_url(@vaga, @candidato), notice: "Candidato was successfully created." }
  ...
  def update
    respond_to do |format|
      if @candidato.update(candidato_params)
        format.html { redirect_to candidato_url(@vaga, @candidato), notice: "Candidato was successfully updated." }
  ...
  private
    ...
    def candidato_params
      params.require(:candidato).permit(:nome, :email, :telefone, :escolaridade, :exp_profissional)
    end
    def set_vaga
